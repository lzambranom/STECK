...
±±º                       ºModif  ³Lucas Riva          ºFecha ³  22/12/16 º±±
...
oPrint:Say(399,0240, "Historial"	,oFont10)
oPrint:Say(399,0850, "C. Costo"	    ,oFont10)
//oPrint:Say(399,1500, "CC.Debe"	,oFont10)
//oPrint:Say(399,1310, "C.C. D/H."	,oFont10)
oPrint:Say(399,1370, "Tercero"	,oFont10)
			...
			If ((cTablaTemp)->(CT2_DOC) >= DctoIni .AND. (cTablaTemp)->(CT2_DOC) <= DctoFin )   //que este dentro de los documentos
				...
				If AllTrim((cTablaTemp)->(CT2_DC)) <> "4"      
					...
					If AllTrim((cTablaTemp)->(CT2_DC)) == "3" 
				    	oPrint:Say(linea-100,2070, RTrim(Transform(nDebito	,"@r 999,999,999.99"))	,oFont07,,,,1)	//Línea Débito   
				    	oPrint:Say(linea	,2270, RTrim(Transform(nCredito	,"@r 999,999,999.99"))	,oFont07,,,,1)	//Línea Crédito
					Else
				 		If nDebito > 0
				  			oPrint:Say(linea,2070, RTrim(Transform(nDebito,"@r 999,999,999.99"))	,oFont07,,,,1)  //Línea Débito
						Endif
				...
				Endif
		   		...
		   		If ALLTRIM((cTablaTemp)->(CT2_DC)) == "3"     
					...
					oPrint:Say(linea, 0240/*0770*/, ALLTRIM(SUBSTR((cTablaTemp)->(CT2_HIST),1,35)),oFont07) 	//Historial
					oPrint:Say(linea, 0850/*1260*/, ALLTRIM(SUBSTR((cTablaTemp)->(CT2_CCD),1,15 )),oFont07)   	//CC.Debe
					oPrint:Say(linea, 1050, ALLTRIM( SUBSTR((cTablaTemp)->(CTT_DESC01),1,18) ) ,oFont07)  		//Descripcion
					oPrint:Say(linea, 1370, ALLTRIM(SUBSTR((cTablaTemp)->(CT2_EC05DB),1,15 )),oFont07)   		//TERCERO - COLOMBIA
					//oPrint:Say(linea, 1570, ALLTRIM(SUBSTR((cTablaTemp)->(CT2_ITEMD),1,5)),oFont07)         	//ItemD
					//--oPrint:Say(linea, 1590, ALLTRIM(SUBSTR((cTablaTemp)->(CV0_DESC),1,20)),oFont07)
					cNombre := Posicione("CV0",2,xFilial("CV0")+ALLTRIM((cTablaTemp)->(CT2_EC05DB)),"CV0_DESC")
					oPrint:Say(linea, 1590, cNombre,oFont07)
					...
					oPrint:Say(linea, 0240/*0770*/, ALLTRIM(SUBSTR((cTablaTemp)->(CT2_HIST),1,35)),oFont07) 	//Historial  
					oPrint:Say(linea, 0850/*1260*/, ALLTRIM(SUBSTR((cTablaTemp)->(CT2_CCC),1,15)),oFont07)  //CC.Haber
					oPrint:Say(linea, 1050, ALLTRIM( SUBSTR((cTablaTemp)->(CTT_2_DESC01),1,18)),oFont07)    //Descripcion 
					oPrint:Say(linea, 1370, ALLTRIM(SUBSTR((cTablaTemp)->(CT2_EC05CR),1,15)),oFont07)    	//TERCERO - COLOMBIA							
					//--oPrint:Say(linea, 1590, ALLTRIM(SUBSTR((cTablaTemp)->(CV0_DESC),1,20)),oFont07)
					cNombre := Posicione("CV0",2,xFilial("CV0")+ALLTRIM((cTablaTemp)->(CT2_EC05CR)),"CV0_DESC")
					oPrint:Say(linea, 1590, cNombre,oFont07)
           		...
           		Else
					...
					oPrint:Say(linea, 0240/*0770*/, ALLTRIM(SubStr((cTablaTemp)->(CT2_HIST),1,35)),oFont07) //Historial
					oPrint:Say(linea, 0850/*1260*/, ALLTRIM(SubStr((cTablaTemp)->(CT2_CCD),1,15 )),oFont07) //CC.Debe
					oPrint:Say(linea, 0850/*1260*/, ALLTRIM(SubStr((cTablaTemp)->(CT2_CCC),1,15)) ,oFont07)  
					oPrint:Say(linea, 1050, ALLTRIM( SUBSTR((cTablaTemp)->(CTT_DESC01),1,18) ) ,oFont07)  	//Descripcion
					oPrint:Say(linea, 1050, ALLTRIM( SUBSTR((cTablaTemp)->(CTT_2_DESC01),1,18)) ,oFont07)	//Descripcion
					oPrint:Say(linea, 1370, ALLTRIM(SubStr((cTablaTemp)->(CT2_EC05DB),1,15)) ,oFont07)   	//CC.Haber
					//oPrint:Say(linea, 1570, ALLTRIM(SubStr((cTablaTemp)->(CT2_ITEMD),1,5)),oFont07)       //ItemD
					//oPrint:Say(linea, 1570, ALLTRIM(SubStr((cTablaTemp)->(CT2_ITEMC),1,5)),oFont07)       //ItemC
					oPrint:Say(linea, 1370, ALLTRIM(SubStr((cTablaTemp)->(CT2_EC05CR),1,15)),oFont07)
					//oPrint:Say(linea, 2380, ALLTRIM( SUBSTR((cTablaTemp)->(CTD_DESC01),1,15) ) ,oFont07)  //Descripcion
					//oPrint:Say(linea, 2380, ALLTRIM( SUBSTR((cTablaTemp)->(CTD_2_DESC01),1,15)),oFont07)  //Descripcion
					//oPrint:Say(linea, 1760, ALLTRIM(SubStr((cTablaTemp)->(CT2_CLVLDB),1,10)),oFont07)     //Vld
					//oPrint:Say(linea, 1760, ALLTRIM(SubStr((cTablaTemp)->(CT2_CLVLCR),1,10)),oFont07)     //Vlc
				    //oPrint:Say(linea, 1590, ALLTRIM(SUBSTR((cTablaTemp)->(CV0_DESC),1,20)),oFont07)
				    If !Empty((cTablaTemp)->(CT2_EC05DB)) .And. Empty((cTablaTemp)->(CT2_EC05CR))
				    	cNombre := Posicione("CV0",2,xFilial("CV0")+ALLTRIM((cTablaTemp)->(CT2_EC05DB)),"CV0_DESC")
				    ElseIf Empty((cTablaTemp)->(CT2_EC05DB)) .And. !Empty((cTablaTemp)->(CT2_EC05CR))
				    	cNombre := Posicione("CV0",2,xFilial("CV0")+ALLTRIM((cTablaTemp)->(CT2_EC05CR)),"CV0_DESC")
				    EndIf
				    
					oPrint:Say(linea, 1590, ALLTRIM(SUBSTR(cNombre,1,20)),oFont07)
					//oPrint:Say(linea, 2850, ALLTRIM( SUBSTR((cTablaTemp)->(CTH_DESC01),1,15) ) ,oFont07)  //Descripcion
					//oPrint:Say(linea, 2850, ALLTRIM( SUBSTR((cTablaTemp)->(CTH_2_DESC01),1,15)),oFont07)  //Descripcion
				Endif
	...
	If TMP->CT2_TPSALD == AllTrim(Str(nTpSld))	//Tipo de Saldo
		...
		If ALLTRIM(TMP->CT2_DC) <> "4"    
			If ALLTRIM(TMP->CT2_DC) == "3"    
			    oPrint:Say(linea-100,2070, RTrim(transform(nDebito,"@r 999,999,999.99")),oFont07,,,,1)  //Linea debito 
			    oPrint:Say(linea,2270, RTrim(transform(nCredito,"@r 999,999,999.99")),oFont07,,,,1)  	//Linea credito	 
		 	Else
				If nDebito > 0
					oPrint:Say(linea,2070, RTrim(transform(nDebito,"@r 999,999,999.99")),oFont07,,,,1)  //Linea debito
				Endif
		...
		If ALLTRIM(TMP->CT2_DC) == "3"  
			...
			linea := linea - 100   
			oPrint:Say(linea, 0240/*0770*/, ALLTRIM(SUBSTR(TMP->CT2_HIST,1,40)),oFont07)                //Historial
			oPrint:Say(linea, 0850, ALLTRIM(SUBSTR(TMP->CT2_CCD,1,10 )),oFont07)         			    //CC.Debe  
			//oPrint:Say(linea, 0770, ALLTRIM(SUBSTR(TMP->CT2_CCD,1,15 )),oFont07)                 		//CC.Debe 
			oPrint:Say(linea, 1050, ALLTRIM(SUBSTR(Posicione("CTT",1,xFilial("CTT")+TMP->CT2_CCD,"CTT_DESC01"),1,18) ) ,oFont07)        //Descripcion
			oPrint:Say(linea, 1370, ALLTRIM(SUBSTR(TMP->CT2_EC05DB,1,15 )),oFont07) 
		   	//oPrint:Say(linea, 1570, ALLTRIM(SUBSTR(TMP->CT2_ITEMD,1,5)),oFont07)               		//ItemD  
			oPrint:Say(linea, 1590, ALLTRIM(SUBSTR(Posicione("CV0",2,xFilial("CV0")+TMP->CT2_EC05DB,"CV0_DESC"),1,20)),oFont07)  
			//oPrint:Say(linea, 2380, ALLTRIM( SUBSTR((cTablaTemp)->(CTD_DESC01),1,15) ) ,oFont07)      //Descripcion 
		    ...
		    linea := linea + 100 
			oPrint:Say(linea, 0240/*0770*/, ALLTRIM(SUBSTR(TMP->CT2_HIST,1,40)),oFont07)				//Historial 
			oPrint:Say(linea, 0850, ALLTRIM(SUBSTR(TMP->CT2_CCC,1,10)),oFont07)                 			//CC.Haber
			//oPrint:Say(linea, 0770, ALLTRIM(SUBSTR(TMP->CT2_CCC,1,15)),oFont07)                 		//CC.Haber
			oPrint:Say(linea, 1050, ALLTRIM( SUBSTR(Posicione("CTT",1,xFilial("CTT")+TMP->CT2_CCC,"CTT_DESC01"),1,18) ) ,oFont07)  	//Descripcion
			oPrint:Say(linea, 1370, ALLTRIM(SUBSTR(TMP->CT2_EC05CR,1,15 )),oFont07) 
		...
		Else
			...
			If !Empty(TMP->CT2_EC05DB)
				oPrint:Say(linea, 1370, ALLTRIM(SUBSTR(TMP->CT2_EC05DB,1,15)),oFont07)
				oPrint:Say(linea, 1590, ALLTRIM(SUBSTR(Posicione("CV0",2,xFilial("CV0")+TMP->CT2_EC05DB,"CV0_DESC"),1,20)),oFont07)
			ElseIf !Empty(TMP->CT2_EC05CR)
				oPrint:Say(linea, 1370, ALLTRIM(SUBSTR(TMP->CT2_EC05CR,1,15)),oFont07)
				oPrint:Say(linea, 1590, ALLTRIM(SUBSTR(Posicione("CV0",2,xFilial("CV0")+TMP->CT2_EC05CR,"CV0_DESC"),1,20)),oFont07)
			EndIf		
		  	//oPrint:Say(linea, 1570, ALLTRIM(SUBSTR(TMP->CT2_ITEMD,1,5)),oFont07)               			//ItemD
			//oPrint:Say(linea, 1570, ALLTRIM(SUBSTR(TMP->CT2_ITEMC,1,5)),oFont07)               			//ItemC
			//oPrint:Say(linea, 1310, ALLTRIM(SUBSTR(TMP->CT2_EC05CR,1,15)),oFont07)
			//oPrint:Say(linea, 2380, ALLTRIM( SUBSTR((cTablaTemp)->(CTD_DESC01),1,15) ) ,oFont07)      //Descripcion
			//oPrint:Say(linea, 2380, ALLTRIM( SUBSTR((cTablaTemp)->(CTD_2_DESC01),1,15) ) ,oFont07)    //Descripcion
		  	//oPrint:Say(linea, 1760, ALLTRIM(SUBSTR(TMP->CT2_CLVLDB,1,10)),oFont07)              		//Vld   
		  	//oPrint:Say(linea, 1760, ALLTRIM(SUBSTR(TMP->CV0_DESC,1,15)),oFont07)
		  	//oPrint:Say(linea, 1760, ALLTRIM(SUBSTR(TMP->CT2_CLVLCR,1,10)),oFont07)              		//Vlc
			//oPrint:Say(linea, 2850, ALLTRIM( SUBSTR((cTablaTemp)->(CTH_DESC01),1,15) ) ,oFont07)      //Descripcion
			//oPrint:Say(linea, 2850, ALLTRIM( SUBSTR((cTablaTemp)->(CTH_2_DESC01),1,15) ) ,oFont07)    //Descripcion
		Endif
